      ...
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-5 sm:p-8">
          ...
          <div className="mb-6 sm:mb-6">
            ...
            {hasSignature ? (
              /* Signed preview */
              <div className="border-2 border-blue-400 rounded-xl overflow-hidden bg-white">
                <canvas
                  ref={canvasRef}
                  width={2000}
                  height={800}
              ...
              /* Hidden canvas for data capture (off-screen but mounted) */
              <canvas
                ref={canvasRef}
                width={2000}
                height={800}
            ...
            {!hasSignature && (
              <p className="text-xs text-slate-400 mt-2">
                Tap "Sign W-9" to open the signature pad
              </p>
            )}
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full h-full flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 flex-shrink-0">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">Draw your signature below</p>
              </div>
            ...
            <div className="flex-1 min-h-0 p-3 sm:p-5 flex flex-col">
              <div className={`relative flex-1 min-h-0 rounded-xl overflow-hidden border-2 transition-colors ${hasSignature ? 'border-blue-400' : 'border-slate-200 border-dashed'}`}>
                <canvas
                  ref={canvasRef}
                  width={2000}
                  height={800}
            ...
            <div className="px-5 py-4 border-t border-slate-100 flex items-center gap-3 flex-shrink-0">
              <button type="button" onClick={clearSignature}
                ...
                className="px-4 py-2.5 border-2 border-slate-200 rounded-xl text-sm font-medium text-slate-600 hover:border-slate-300 disabled:opacity-40 transition-colors">
                Clear
              </button>
              <button type="button"
